        ...
        continueid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!enteredchapid.getText().toString().isEmpty()) {
                    ...
                    chapterID.child(enteredchapid.getText().toString()).addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener() {
                        @Override
                        public void onDataChange(final com.google.firebase.database.DataSnapshot dataSnapshot) {
                            if (!dataSnapshot.exists()) {
                                ...
                                AlertDialog moveon = new AlertDialog.Builder(JoinChapter.this)
                                        ...
                                        .setMessage("Chapter ID: " + dataSnapshot.child("Setup").child("ID").getValue()
                                                + "\nChapter Name: " + dataSnapshot.child("Setup").child("ChapterName").getValue()
                                                + "\nState: " + dataSnapshot.child("Setup").child("State").getValue() +
                                                "\nZip code: " + dataSnapshot.child("Setup").child("Zip").getValue())
                                        ...
                                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int whichButton) {
                                                ...
                                                intent.putExtra("membercode", dataSnapshot.child("JoinCodes").child("MemberCode").getValue().toString());
                                                intent.putExtra("advisercode", dataSnapshot.child("JoinCodes").child("AdviserCode").getValue().toString());
                                                intent.putExtra("chapterid", enteredchapid.getText().toString());
                                                intent.putExtra("chapterlogourl", dataSnapshot.child("Images").child("ChapterLogo").getValue().toString());
