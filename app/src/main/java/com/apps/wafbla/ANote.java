                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.child("Users").exists()){
                            ...
                            for (DataSnapshot childSnapshot: dataSnapshot.child("Users").getChildren()) {
                                adts += childSnapshot.child("device_token").getValue().toString() + ",";
                                uids.add(childSnapshot.child("uid").getValue().toString());
                            }
                            ...
                            Intent i = new Intent(getApplicationContext(), FBLAHome.class);
                            startActivity(i);
                            overridePendingTransition(R.anim.left_to_right, R.anim.right_to_left);
                            finish();
                            ...
                            Toast.makeText(getApplicationContext(), "No members in your chapter, cant send message", Toast.LENGTH_SHORT).show();
                            Intent i = new Intent(getApplicationContext(), FBLAHome.class);
                            startActivity(i);
                            overridePendingTransition(R.anim.left_to_right, R.anim.right_to_left);
                            finish();
